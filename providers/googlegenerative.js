...
async function generateResponse(smartResponse, message, phrase) {
    try {
        ...
        const instance = createGoogleGenerativeAI({ apiKey: smartResponse.config.Providers.GoogleGenerative.APIKey });
        ...
        const model = instance(smartResponse.config.Providers.GoogleGenerative.Model);
        ...
        console.error('googleGenerative API Error:', error);
